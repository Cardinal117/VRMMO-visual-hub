...
import MeleeStancesSlide from './melee-slides/MeleeStancesSlide';
import MeleeWeaponIdentitySlide from './melee-slides/MeleeWeaponIdentitySlide';
import MeleeRecognitionSlide from './melee-slides/MeleeRecognitionSlide';
import MeleeCombatExampleSlide from './melee-slides/MeleeCombatExampleSlide';
import MeleeOutroSlide from './melee-slides/MeleeOutroSlide';

const slides = [
  MeleeIntroSlide,
  MeleeProgressionSlide,
  MeleeStancesSlide,
  MeleeWeaponIdentitySlide,
  MeleeRecognitionSlide,
  MeleeCombatExampleSlide,
  MeleeOutroSlide,
];

export default function MeleePresentation({ onBack }: { onBack: () => void }) {
